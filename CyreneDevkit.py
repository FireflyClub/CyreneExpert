...
from src.util.config import Open, Info, CFG
...
class Main(FramelessWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('CyreneDevkit')
...
class Devkit(ScrollArea):
    ...
    def __connectSignalToSlot(self):
        self.HandbookCard.clicked.connect(lambda: Open(self, '.\\devkit\\handbook\\'))

        self.ConvertCard.convert_clear.connect(lambda: self.handleConvert('clear'))
        self.ConvertCard.convert_open.connect(lambda: Open(self, '.\\devkit\\output\\'))
        ...
        self.translateCard.translate_open.connect(lambda: Open(self, '.\\devkit\\translate\\'))
